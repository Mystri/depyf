...
# kernel path: /tmp/torchinductor_root/ya/cyamn5dfmkbdwzso7ckpvuzjbf5acyfstbmih4iwghpxy7ccwcjh.py
...
#   %add : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%cos, %arg1_1), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_cos_sin_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'ADD422BD172A0988DC6B2FB6CF49464040C5993A7FDC4BFD9B7F4CB74AEE5ACF', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 32}},
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_add_cos_sin_0.run(arg0_1, arg1_1, buf0, 4, stream=stream0)
        del arg0_1
        del arg1_1
    return (buf0, )
